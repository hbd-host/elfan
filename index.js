...
x = setInterval(function() {
    ...
    function Letter(char, x, y) {
        ...
        // Mengganti kode untuk mengatur warna huruf dan kembang api menjadi biru
        let hue = 210; // Menggunakan hue untuk biru (210 adalah nilai untuk biru pada HSL)
        this.color = 'hsl(' + hue + ',80%,50%)'; // Ubah warna karakter menjadi biru
        this.lightAlphaColor = 'hsla(' + hue + ',80%,light%,alp)'; // Ubah warna karakter untuk cahaya biru
        this.lightColor = 'hsl(' + hue + ',80%,light%)'; // Ubah warna karakter untuk cahaya biru
        this.alphaColor = 'hsla(' + hue + ',80%,50%,alp)'; // Ubah warna karakter untuk alpha biru
